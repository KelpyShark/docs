...
<h1 id="kelpyshark-quick-reference">KelpyShark Quick Reference</h1>
<p>This quick reference provides a concise summary of KelpyShark&#39;s syntax, features, and standard library. Use it as a cheat sheet while coding.</p>
<hr>
...
<li>Strings: <code>&quot;text&quot;</code></li>
<li>Lists: <code>[1, 2, 3]</code></li>
<li>Dictionaries: <code>{ &quot;key&quot;: &quot;value&quot; }</code></li>
...
<pre><code class="lang-kelpyshark"><span class="hljs-keyword">if</span> x &gt; 0 {
...
<pre><code class="lang-kelpyshark"><span class="hljs-keyword">for</span> i <span class="hljs-keyword">in</span> <span class="hljs-built_in">range</span>(<span class="hljs-number">5</span>) {
...
<pre><code class="lang-kelpyshark"><span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Person</span> {</span>
    ...
    <span class="hljs-function"><span class="hljs-keyword">def</span> <span class="hljs-title">greet</span><span class="hljs-params">(<span class="hljs-keyword">self</span>)</span></span> {
        print(<span class="hljs-string">"Hello, "</span> + <span class="hljs-keyword">self</span>.name)
    }
}
</code></pre>
...
<pre><code class="lang-kelpyshark"><span class="hljs-built_in">file</span> = <span class="hljs-built_in">open</span>(<span class="hljs-string">"data.txt"</span>, <span class="hljs-string">"r"</span>)
content = <span class="hljs-built_in">file</span>.<span class="hljs-built_in">read</span>()
...
<span class="hljs-built_in">print</span>(<span class="hljs-built_in">math</span>.sqrt(<span class="hljs-number">16</span>))
</code></pre>
...
<li><code>len(obj)</code>: Get length</li>
<li><code>range(n)</code>: Generate numbers 0 to n-1</li>
<li><code>open(filename, mode)</code>: Open a file</li>
</ul>
<hr>
<h2 id="cli-package-manager">CLI &amp; Package Manager</h2>
<ul>
<li>Run a script: <code>kelpyshark myfile.ks</code></li>
<li>Install package: <code>kelpyshark pkg install &lt;name&gt;</code></li>
<li>List packages: <code>kelpyshark pkg list</code></li>
</ul>
<hr>
...
<li>Statements end at line breaks</li>
</ul>
<hr>
<h2 id="more">More</h2>
<p>See the full tutorial for detailed explanations and examples of every feature.</p>
