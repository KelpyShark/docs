...
<p>Methods are functions that operate on objects. In KelpyShark, full method support is planned for future versions. For now, use functions that take a dictionary (object) as the first argument.</p>
...
<ul>
<li>Methods are not yet available as part of class syntax.</li>
<li>Use functions to simulate methods.</li>
</ul>
